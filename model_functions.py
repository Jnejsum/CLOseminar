...
class CLOModel():
    ...
    def setup(self, **kwargs):
        ...
        self.c = 0.07 # risk premium parameter
        self.gamma = 1 # scalar on rf in drift calculation      
    ...
    def GBM_fig(self):
        ...
        drift = (self.c + self.gamma * self.rf) - 0.5 * self.sigma ** 2
    ...
    def GBM(self, risk_neutral=False):
        ...
        else: drift = (self.c + self.gamma * self.rf) - 0.5 * self.sigma ** 2
    ...
    def face_value(self):
        ...
        return self.V0 / np.exp( - norm.ppf(def_prob) * self.sigma * np.sqrt(self.T)
                                 - ( (self.c + self.gamma * self.rf) - 0.5 * self.sigma ** 2 ) * self.T )
